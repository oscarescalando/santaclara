...
import 'package:santaclara/countries/ui/widget/listcountry_widget.dart';
...
class PlayerFormWidget extends StatefulWidget {
  ...
  PlayerFormWidget(this.bookingId, this.scaffolKey, this.indexId,
      [this.fullName, this.email, this.countryId, this.id, this.isEdit]);
    ...
    return isLoading
        ...
        : ExpansionTile(
            title: Text(
              ...
              style: TextStyle(fontSize: fontB2, fontWeight: FontWeight.bold),
            ),
            children: <Widget>[
                Container(
                            ...
                            TextFormField(
                              ...
                              decoration: const InputDecoration(
                                ...
                                labelStyle: TextStyle(
                                    fontSize: fontB2,
                                    fontWeight:
                                        FontWeight.w300 //Titulo en negritas
                                    ),
                              ),
